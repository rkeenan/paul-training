package com.paul.training.core.schedulers;
...
/**
 * A simple demo for cron-job like tasks that get executed regularly. It also demonstrates how
 * property values can be set. Users can set the property values in /system/console/configMgr
 */
